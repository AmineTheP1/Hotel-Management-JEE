            ...
            <div class="md:w-2/3 lg:w-3/4">
                ...
                <div class="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
                    <div class="flex border-b">
                        <button id="tab-security" class="tab-btn flex-1 py-4 px-6 text-center font-medium tab-active">
                            <i class="fas fa-lock mr-2"></i> Sécurité
                        </button>
                        <button id="tab-preferences" class="tab-btn flex-1 py-4 px-6 text-center font-medium text-gray-500">
                            <i class="fas fa-sliders-h mr-2"></i> Préférences
                        </button>
                        <button id="tab-privacy" class="tab-btn flex-1 py-4 px-6 text-center font-medium text-gray-500">
                            <i class="fas fa-user-shield mr-2"></i> Confidentialité
                        </button>
                        <button id="tab-account" class="tab-btn flex-1 py-4 px-6 text-center font-medium text-gray-500">
                            <i class="fas fa-user-times mr-2"></i> Compte
                        </button>
                    </div>
