            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center flex-1 max-w-md mx-8">
                    <div class="w-full relative">
                        <input type="text" placeholder="Search for users by name, email..." class="w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="p-4">
                <div class="mb-6">
                    ...
                    <ul class="mt-3 space-y-1">
                        ...
                        <li>
                            <a href="users.jsp" class="flex items-center px-3 py-2 text-blue-600 bg-blue-50 rounded-md">
