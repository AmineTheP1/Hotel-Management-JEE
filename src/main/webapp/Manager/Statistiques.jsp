            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center flex-1 max-w-md mx-8">
                    <div class="w-full relative">
                        <input type="text" placeholder="Search for statistics data..." class="w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="p-4">
                ...
                <div class="mb-6">
                    ...
                    <ul class="mt-3 space-y-1">
                        ...
                        <li>
                            <a href="Statistiques.jsp" class="flex items-center px-3 py-2 text-blue-600 bg-blue-50 rounded-md">
                ...
                <div>
                    <h3 class="text-xs uppercase text-gray-500 font-semibold tracking-wider">Help</h3>
                    <ul class="mt-3 space-y-1">
                        <li>
                            <a href="#" class="flex items-center px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-md">
