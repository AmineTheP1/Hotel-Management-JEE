            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center flex-1 max-w-md mx-8">
                    <div class="w-full relative">
                        <input type="text" placeholder="Rechercher des paramètres..." class="w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-blue-500 focus:border-blue-500">
    ...
    <div class="flex">
        ...
        <aside class="bg-white w-64 shadow-sm sidebar" id="sidebar">
            <div class="p-4">
                ...
                <div class="mb-6">
                    <h3 class="text-xs uppercase text-gray-500 font-semibold tracking-wider">Configuration</h3>
                    <ul class="mt-3 space-y-1">
                        <li>
                            <a href="Settings.jsp" class="flex items-center px-3 py-2 text-blue-600 bg-blue-50 rounded-md">
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="bg-white rounded-lg shadow-sm overflow-hidden mb-8">
                    <div class="flex border-b">
                        <button class="tab-button px-6 py-3 text-sm font-medium text-blue-600 border-b-2 border-blue-600 active" data-tab="general">
                            <i class="fas fa-sliders-h mr-2"></i> Général
                        </button>
                        <button class="tab-button px-6 py-3 text-sm font-medium text-gray-500 hover:text-gray-700" data-tab="email">
                            <i class="fas fa-envelope mr-2"></i> Email
                        </button>
                        <button class="tab-button px-6 py-3 text-sm font-medium text-gray-500 hover:text-gray-700" data-tab="payment">
                            <i class="fas fa-credit-card mr-2"></i> Paiement
                        </button>
                        <button class="tab-button px-6 py-3 text-sm font-medium text-gray-500 hover:text-gray-700" data-tab="api">
                            <i class="fas fa-plug mr-2"></i> API
                        </button>
                        <button class="tab-button px-6 py-3 text-sm font-medium text-gray-500 hover:text-gray-700" data-tab="templates">
