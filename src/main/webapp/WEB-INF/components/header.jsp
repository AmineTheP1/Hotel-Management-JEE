                            ...
                            <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 hidden group-hover:block">
                                <c:choose>
                                    <c:when test="${sessionScope.userRole == 'client'}">
                                        <a href="Client/dashboard.jsp" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Dashboard</a>
                                        <a href="Client/bookings.jsp" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">My Bookings</a>
                                    </c:when>
                                    <c:when test="${sessionScope.userRole == 'employee'}">
                                        <a href="Employee/Dashboard.jsp" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Dashboard</a>
                                        <a href="Employee/Booking.jsp" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Bookings</a>
                                    </c:when>
                                    <c:when test="${sessionScope.userRole == 'manager'}">
                                        <a href="Manager/admin-dashboard.jsp" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Dashboard</a>
                                        <a href="Manager/users.jsp" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Users</a>
                                    </c:when>
                                </c:choose>
