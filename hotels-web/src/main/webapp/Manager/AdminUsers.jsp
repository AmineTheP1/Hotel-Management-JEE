...
<%
    ...
    // Admin information - first check if it's in session
    ...
    try {
        // Establish database connection - reuse the same connection variables
        Class.forName("com.mysql.cj.jdbc.Driver");
        conn = DriverManager.getConnection(url, username, password);
        
        // Get admin user information if not already set
