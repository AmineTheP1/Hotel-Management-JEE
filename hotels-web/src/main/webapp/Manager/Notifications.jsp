...
<%
        ...
        if (userRs.next()) {
            ...
            if ("mark_read".equals(action)) {
                ...
                if (notificationIds != null && notificationIds.length > 0) {
                    String updateQuery = "UPDATE notifications SET is_read = 1 WHERE notification_id = ?";
    ...
    try {
        ...
        String notificationsQuery = "SELECT n.notification_id, n.title, n.message, n.type, n.is_read, n.created_at, " +
        ...
        while (rs.next()) {
            ...
            userData.put("user_id",     rs.getInt("user_id"));  // pas "id"
            userData.put("user_name",   rs.getString("first_name") + " " +
