                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative">
                        <button class="flex items-center text-gray-800 hover:text-blue-600">
                            <% if (user.get("profileImage") != null && !user.get("profileImage").toString().isEmpty()) { %>
        ...
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="md:w-1/3 lg:w-1/4">
                <div class="bg-white rounded-lg shadow-sm p-6 sticky top-24">
                    ...
                    <!-- Navigation Tabs -->
                    <div class="space-y-1">
                        <a href="Profile.jsp" class="w-full flex items-center px-4 py-3 text-blue-600 bg-blue-50 rounded-md">
